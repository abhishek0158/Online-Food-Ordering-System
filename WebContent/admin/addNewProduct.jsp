...
<div class="left-div">
 ...
 <input style="color:black" class="input-style" type="text" name="name" placeholder="Enter Name" required>
<hr>
</div>
...
<div class="right-div">
<h3 style="color:black">Image Source</h3>
 <input class="input-style" type="text" name="image" placeholder="Enter Image Source" required>
<hr>
</div>

<div class="left-div">
<h3 style="color:black">Store Details</h3>
 <input class="input-style" type="text" name="store" placeholder="Enter Store Details" required>
<hr>
</div>
